...
users = {
    ...
    'driver1': {'password': 'driver1pass', 'role': 'driver1'},
    'driver2': {'password': 'driver2pass', 'role': 'driver2'},
    'driver3': {'password': 'driver3pass', 'role': 'driver3'},
...
def ver_mapa():
    ...
    path='/home/Benjamin718/mysite/static/mapa_cbb.html'
    m.save(path)
